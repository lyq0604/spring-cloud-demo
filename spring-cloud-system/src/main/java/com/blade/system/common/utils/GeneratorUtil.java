...
public class GeneratorUtil {
     ...
     * service文件位置
     */
    public static String SERVICE_TEMPLATE_LOCATION = "java/service/BaseService.java.ftl";
    ...
    public static String getJavaFullPath(Generator generator, String templateType) {
        ...
        switch (typeEnum) {
            ...
            case MAPPER:
                ...
                break;
            case MAPPERXML:
                fullPath.append("/mapper/" + className + "Mapper.xml");
                break;
            case SERVICE:
                fullPath.append("/service/" + className + "Service.java");
                break;
            case CONTROLLER:
