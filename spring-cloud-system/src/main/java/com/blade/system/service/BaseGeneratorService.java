...
public class BaseGeneratorService {
    ...
    public List<String> selectDatabaseList() {
        return baseGeneratorMapper.selectDatabaseInfo();
    }

    public List<TableVO> selectTableList(String database,String tableName){
        return baseGeneratorMapper.selectTableList(database,tableName);
    }
     ...
     * @param generator
     */
    private void buildInfo(BaseGenerator generator) {
    ...
    public List<ColumnInfo> selectColumnList(String database, String tableName) {
        return baseGeneratorMapper.selectColumnList(database,tableName);
    }
}
